...
namespace Lykke.blue.Service.ReferralLinks.Services.Bitcoin
{
    public class BitcoinApiClientLocal
    {
        ...
        public BitcoinApiClientLocal(AppSettings settings)
        {
            _apiClient = new BitcoinApi(new Uri(settings.BitCoinCore.BitcoinCoreApiUrl));
