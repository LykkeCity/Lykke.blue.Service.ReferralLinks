...
namespace Lykke.blue.Service.ReferralLinks.Core.Domain.Offchain
{
    ...
    {
        Task<IOffchainTransfer> CreateTransfer(string transactionId, string clientId, string assetId, decimal amount, OffchainTransferType type, string externalTransferId, bool channelClosing = false);
