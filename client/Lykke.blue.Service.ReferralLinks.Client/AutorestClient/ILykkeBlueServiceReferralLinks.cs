...
namespace Lykke.blue.Service.ReferralLinks.Client.AutorestClient
{
    ...
    public partial interface ILykkeBlueServiceReferralLinks : System.IDisposable
    {
        ...
        /// The cancellation token.
        /// </param>
        Task<HttpOperationResponse<object>> GroupTransferToLykkeHotWalletWithHttpMessagesAsync(OffchainGroupLinkTransferToLykkeModel model = default(OffchainGroupLinkTransferToLykkeModel), Dictionary<string, List<string>> customHeaders = null, CancellationToken cancellationToken = default(CancellationToken));
        ...
        /// The cancellation token.
        /// </param>
        Task<HttpOperationResponse<object>> GetReferralLinkByGroupIdWithHttpMessagesAsync(string groupId, Dictionary<string, List<string>> customHeaders = null, CancellationToken cancellationToken = default(CancellationToken));
